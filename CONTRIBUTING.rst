...
The best way to send feedback is to file an issue at https://github.com/nvieira-mcgill/amakihi/issues.
...
Ready to contribute? Here's how to set up `amakihi` for local development.

1. Fork the `amakihi` repo on GitHub.
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/nvieira-mcgill/amakihi/pull_requests
